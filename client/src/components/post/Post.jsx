        ...
        <span id="rightbarOnline"></span>
                ...
                </div>
                {
                                                      ...
                                                      (
                                                        ...
                                                        <div style={{marginLeft:"30px", marginTop:"20px"}} className="media mb-4">
                <div id="rightbarProfileImgContainer">
        <img id="rightbarProfileImg"  alt="" src="assets/person/lycute.jpg" />
        <span id="rightbarOnline"></span>
      </div>
                    <div className="media-body">
                    <h6 className="mt-0">Khánh Ly {<i style={{color:"#3AE7E1", fontSize:"1.2em"}} class="fas fa-check-square"></i>}</h6>
